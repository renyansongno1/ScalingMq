...
public class BrokerHttpNetEventHandler extends SimpleChannelInboundHandler<FullHttpRequest> {

    private static final BrokerHttpNetEventHandler INSTANCE = new BrokerHttpNetEventHandler();
    ...
    private BrokerHttpNetEventHandler() {
        if (INSTANCE != null) {
            throw new RuntimeException("not support reflect invoke");
        }
    }

    public static BrokerHttpNetEventHandler getInstance() {
        return INSTANCE;
    }
